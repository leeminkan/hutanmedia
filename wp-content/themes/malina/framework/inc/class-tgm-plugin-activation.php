 ...
 * @version   2.6.1 for parent theme Malina for publication on ThemeForest
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		/**
		 * Get name of default pmalinary column
		 *
		 ...
		 * @return string
		 */
		protected function get_default_pmalinary_column_name() {
			return 'plugin';
		}

		/**
		 * Get the name of the pmalinary column.
		 *
		 * @since 2.5.0 / WP 4.3+ compatibility
		 * @access protected
		 *
		 * @return string The name of the pmalinary column.
		 */
		protected function get_pmalinary_column_name() {
			if ( method_exists( 'WP_List_Table', 'get_pmalinary_column_name' ) ) {
				return parent::get_pmalinary_column_name();
			} else {
				return $this->get_default_pmalinary_column_name();
			}
		}
		...
		public function prepare_items() {
			...
			$pmalinary               = $this->get_pmalinary_column_name(); // Column which has the row actions.
			$this->_column_headers = array( $columns, $hidden, $sortable, $pmalinary ); // Get all necessary column headers.
