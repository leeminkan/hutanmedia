...
.editor-styles-wrapper {
    font-family: <?php echo esc_attr(get_theme_mod( 'malina_body_font_family', 'Open Sans' )); ?> !important;
    font-size: <?php echo esc_attr(get_theme_mod( 'malina_body_font_size', '17px' )); ?> !important;
    color: <?php echo esc_attr(get_theme_mod('malina_body_color', '#444b4d')); ?> !important;
}
...
.editor-post-title__block .editor-post-title__input { 
    ...
    font-weight: <?php echo esc_attr(get_theme_mod( 'malina_posts_headings_font_weight', '700' )); ?>;
    font-size: <?php echo esc_attr(get_theme_mod( 'malina_posts_headings_font_size', '36' )); ?>px;
    text-transform: <?php echo esc_attr(get_theme_mod( 'malina_post_headings_transform', 'capitalize' )); ?>;
    letter-spacing:<?php echo esc_attr( get_theme_mod( 'malina_posts_headings_letter_spacing', '1.5') ); ?>px;
}
.editor-styles-wrapper h1, .editor-styles-wrapper h2, .editor-styles-wrapper h3, .editor-styles-wrapper h4, .editor-styles-wrapper h5, .editor-styles-wrapper h6, .editor-styles-wrapper .has-drop-cap:first-letter {
    font-family: '<?php echo esc_attr(get_theme_mod( 'malina_posts_headings_font_family', 'Montserrat' )); ?>';
    font-weight: <?php echo esc_attr(get_theme_mod( 'malina_posts_headings_font_weight', '500' )); ?>;
    letter-spacing:<?php echo esc_attr( get_theme_mod( 'malina_posts_headings_letter_spacing', '1.5') ); ?>px;
    margin-bottom:15px;
}
.editor-styles-wrapper h1:not(.has-text-color), .editor-styles-wrapper h2:not(.has-text-color), .editor-styles-wrapper h3:not(.has-text-color), .editor-styles-wrapper h4:not(.has-text-color), .editor-styles-wrapper h5:not(.has-text-color), .editor-styles-wrapper h6:not(.has-text-color) {
    color: <?php echo esc_attr(get_theme_mod('malina_posts_headings_item_color', '#1c1d1f')); ?> !important;
}
...
.wp-block.editor-block-list__block .editor-block-list__block-edit .block_title {
