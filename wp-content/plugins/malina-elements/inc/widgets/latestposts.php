<?php
add_action('widgets_init','register_malina_grid_post_posts_widget');
function register_malina_grid_post_posts_widget(){
    register_widget('malina_grid_posts_widget');
}

class malina_grid_posts_widget extends WP_Widget{

    function __construct(){
        parent::__construct( 'malina_grid_posts_widget','malina-Mega Menu Posts',array('description' => 'Grid Posts widget to display in WP Mega Menu. Do not use it in your sidebar.'));
    }
    ...
    function form($instance)
    {
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e('Widget Title', 'malina-elements'); ?></label>
            <input id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" style="width:100%;" />
        </p>

        <p>
            <label for="<?php echo $this->get_field_id( 'order_by' ); ?>"><?php esc_html_e('Ordered By', 'malina-elements'); ?></label>
            <?php
            $options = array(
                'popular' 	=> 'Popular',
                'latest' 	=> 'Latest',
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'category' ); ?>"><?php esc_html_e('Select Category', 'malina-elements'); ?></label>
            <?php
            $options = array();
            $options['allpost'] = 'All';
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'no_column' ); ?>"><?php esc_html_e('Number of Column', 'malina-elements'); ?></label>
            <?php
            $options = array(
                'col1' 	=> 'Column 1',
                'col2' 	=> 'Column 2',
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php esc_html_e('Post Count', 'malina-elements'); ?></label>
